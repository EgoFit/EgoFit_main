...
urlpatterns = [
    ...
    path('profile/analysis/', profile_views.ProfileAnalysisView.as_view(), name='profile_analysis'),
    path('profile_courses/', profile_views.ProfileCoursesView.as_view(), name='profile_course'),
    path('profile_plans/', profile_views.ProfileDocumentsView.as_view(), name='profile_plans'),
    ...
    path('profile/workout-programs/', workout_views.ProfileWorkoutProgramsView.as_view(), name='profile_workout_programs'),
    path('profile/workout-programs/<int:pk>/performance/', workout_views.ProfileWorkoutProgramPerformanceView.as_view(), name='profile_workout_program_performance'),
    ...
    path('profile/workout-programs/<int:pk>/pdf/', workout_views.ProfileWorkoutProgramPdfView.as_view(), name='profile_workout_program_pdf'),
    path('profile/workout-programs/movement/<slug:kind>/<int:movement_id>/', workout_views.ProfileWorkoutMovementView.as_view(), name='profile_workout_movement'),
    path('profile/coach/', profile_views.ProfileCoachView.as_view(), name='profile_coach'),
    path('profile_financial/', profile_views.ProfileFinancialView.as_view(), name='profile_financial'),
    path('profile_comments/', profile_views.ProfileCommentsView.as_view(), name='profile_comments'),
    path('profile_notifications/', profile_views.ProfileNotificationsView.as_view(), name='profile_notifications'),
    path('profile_useredit/', profile_views.edit_user_profile, name='profile_useredit'),
    ...
    path('profile/metric/<slug:metric>/', profile_views.ProfileMetricEditView.as_view(), name='profile_metric_edit'),
    path('profile/weight/', profile_views.ProfileMetricEditView.as_view(), {'metric': 'weight'}, name='profile_weight_edit'),
    path('profile/height/', profile_views.ProfileMetricEditView.as_view(), {'metric': 'height'}, name='profile_height_edit'),
    path('profile/birth-date/', profile_views.ProfileMetricEditView.as_view(), {'metric': 'birth_date'}, name='profile_birth_date_edit'),
    path('profile/blood-group/', profile_views.ProfileMetricEditView.as_view(), {'metric': 'blood_group'}, name='profile_blood_group_edit'),
    ...
    path('add_course/<int:series_id>/', profile_views.AddCourseToProfileView.as_view(), name='add_course_to_profile'),
